...
public class DeviceCatalogApplicationExceptionCode {
    ...
    public static final SmartHomeExceptionDetails DeviceCatalogDeviceNotFoundByTypeCode = new SmartHomeExceptionDetails("DEVICE_CATALOG_DEVICE_NOT_FOUND_BY_TYPE_CODE", "Device type code unknown");
